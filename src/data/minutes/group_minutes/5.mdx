...
---
import prototipo from '~/assets/images/prototipopapel.png';

# Minute 5 - 08/03, 10:00 - Online
...
<img src={prototipo.src} alt="Use Cases" style="width: 90%; margin-top: 2rem; margin-bottom: 2rem;"/>
