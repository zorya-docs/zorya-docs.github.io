...
- UI lista das minutas: `src/meetings/index.astro`
- UI de cada minuta: `src/meetings/[...slug].astro`
- Os dados das minutas estão em `src/data/meetings`

**Notas:**

- Isto usa tailwind, há milhares de componentes que podemos roubar :3
